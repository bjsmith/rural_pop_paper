...
```{r}
table(hints5$Gender3C)/length(hints5$Gender3C)
print(table(hints5$RacePreprocessed2)/length(hints5$RacePreprocessed2))
print(table(hints5$RacePreprocessed2))

print(summary(hints5$Age,na.rm = TRUE))
print(sd(hints5$Age,na.rm = TRUE))
```
...
```{r}
descriptions<-orfcs_dataset %>% filter(RuralZIP==TRUE) %>% .$RUCA_Description
print(table(descriptions))
print(table(descriptions)/length(descriptions))
```

```{r}
table(orfcs_dataset$Gender3C)/length(orfcs_dataset$Gender3C)
table(orfcs_dataset$RaceC2)/length(orfcs_dataset$RaceC2)
print(summary(orfcs_dataset$DEMO_Age,na.rm = TRUE))
print(sd(orfcs_dataset$DEMO_Age,na.rm = TRUE))
```
